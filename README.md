...
**Features:** year multi-select per chart (All/None, URL `?sp=2024,2025&btc=2025&overlay=2024`), dark mode (OS `prefers-color-scheme` default + manual System/Light/Dark toggle persisted in `localStorage`), responsive layout.
