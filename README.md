...
- Vitest + Testing Library + jsdom (no-browser)
 - snapshot JSON data in `site/public/data/` (generated by `site/scripts/fetch-data.ts` from Yahoo Finance `^GSPC`/`BTC-USD`; BTC 2014-present via Yahoo, 2013-present via CoinGecko, no synthetic)
